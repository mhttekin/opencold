...
SYSTEM_PROMPT = (
    ...
    "1. OUTPUT FORMAT: Your output has exactly TWO parts:\n"
    "   LINE 1: A short subject line (2-6 words, no 'Subject:' prefix).\n"
    "   Then a blank line.\n"
    "   Then the email body (3 short paragraphs).\n"
    "   No greeting (no 'Hi Name,', 'Dear', 'Hello', 'Hey'). "
    ...
    "- Does the FIRST LINE contain ONLY a short subject line (2-6 words)?\n"
    "- Is there a BLANK LINE between the subject and body?\n"
    "- Is the body EXACTLY 3 short paragraphs? (not 2, not 4)\n"
    "- Is it under 80 words total (body only, excluding subject)?\n"
...
def build_user_prompt(
    ...
    parts.append(
        ...
        "CRITICAL: First line = short subject line (2-6 words, no 'Subject:' prefix). "
        "Then a blank line. Then the email body, exactly 3 short paragraphs. "
        "Max 80 words in the body. No markdown. No commentary. No explanations. "
